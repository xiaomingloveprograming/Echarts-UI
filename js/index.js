...
// 柱状图模块1     立即执行函数的妙用：里面声明的变量都是局部变量，避免全局污染
(function () {
    ...
    series: [
        {
          ...
          itemStyle: {
            ...
            color: function (params) {
              // console.log(params);
              // params传进来的是一个对象,其中dataIndex属性是当前柱子的索引号
...
(function () {
  ...
  $('.line h2').on('click', 'a', function () {
    // $(this).index() 返回当前点击的a 的索引值
    // 点击a之后，根据当前a的索引号，找到对应yearData的相关对象
    ...
    series: [
      {
        ...
        // 设置饼形图再容器中的位置
        center: ['50%','45%'],
        // radius修改 '内圆半径' 和 '外圆半径' 的大小，都是相对于容器宽度的百分比
        radius: ['40%', '60%'],
